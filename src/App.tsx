...
export default function App() {
  ...
  const [receiverBalance, setReceiverBalance] = useState<any | undefined>(
    undefined
  );
  ...
  const createSender = async () => {
    ...
    console.log('Sender Address: ', senderKeypair!.publicKey.toString());
